...
import { BrainCircuit, Eye, EyeOff, ArrowRight, Mail, Lock } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-grid">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="glass-card rounded-3xl p-8" style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <p className="text-sm text-white/40 mb-8">Continue your interview preparation journey</p>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-amber-400 hover:text-amber-300 transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
          ...
          {/* OAuth */}
          <button className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm text-white/60 hover:text-white transition-all glass-card glass-card-hover">
          ...
          <p className="text-center text-xs text-white/30 mt-6">
            ...
            <Link href="/student-register" className="text-amber-400 hover:text-amber-300 transition-colors font-medium">
              Sign up free
            </Link>
          </p>
        </div>
