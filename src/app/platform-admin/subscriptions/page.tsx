...
// Lazy load the Account Detail Modal
const AccountDetailModal = dynamic(
  () => import("@/components/admin/subscriptions/AccountDetailModal").then((mod) => ({ default: mod.AccountDetailModal })),
  {
    loading: () => null,
    ssr: false,
  }
...
export default function SubscriptionsPage() {
  ...
  const [selectedAccount, setSelectedAccount] = useState<B2CAccount | null>(null);
  ...
  const handleAccountUpdate = (updatedAccount: B2CAccount) => {
