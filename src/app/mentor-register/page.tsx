            ...
            <div className="w-full max-w-lg rounded-3xl border border-white/10 bg-gradient-to-b from-gray-900/90 to-gray-950/90 p-10 backdrop-blur-xl shadow-2xl">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full h-14 pl-12 pr-5 rounded-2xl border border-white/10 bg-white/5 text-base text-white placeholder:text-gray-500 backdrop-blur-xl transition-all duration-200 focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white/10 outline-none"
                                />
                            </div>
                        </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                required
                                className="w-full h-14 pl-12 pr-14 rounded-2xl border-2 border-emerald-500/30 bg-white/5 text-base text-white placeholder:text-gray-500 backdrop-blur-xl transition-all duration-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30 focus:bg-white/10 outline-none"
                            />
                            <button
                                type="button"
                    ...
                    <Button
                        type="submit"
                        disabled={isLoading}
                        className="w-full h-14 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 px-6 text-lg font-bold text-white shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all duration-300 hover:from-emerald-600 hover:to-teal-700 hover:shadow-[0_0_40px_rgba(16,185,129,0.6)] hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
                    >
                        {isLoading ? (
                            <>
