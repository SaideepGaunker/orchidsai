...
const mentorNavItems = [
  { icon: LayoutDashboard, label: "Mentor Overview", href: "/mentor" },
  { icon: Users, label: "Student Batches", href: "/mentor/students" },
  { icon: BarChart3, label: "Institution Analytics", href: "/mentor/analytics" },
  { icon: UserPlus, label: "Invite Students", href: "/mentor/invite" },
  { icon: User, label: "My Profile", href: "/mentor/my-profile" },
];
